###########################################################################
## Makefile generated for component 'DataAcquisition_RPM'. 
## 
## Makefile     : DataAcquisition_RPM.mk
## Generated on : Sun Nov 19 18:24:42 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DataAcquisition_RPM.elf
...
SLIB_PATH                 = C:/Users/PRASHA~1/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DataAcquisition_RPM.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/shared/svd/include -I$(START_DIR)/DataAcquisition_RPM_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=DataAcquisition_RPM -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o DataAcquisition_RPM.o DataAcquisition_RPM_data.o encoder_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/DataAcquisition_RPM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/DataAcquisition_RPM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/DataAcquisition_RPM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DataAcquisition_RPM.o : $(START_DIR)/DataAcquisition_RPM_ert_rtw/DataAcquisition_RPM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DataAcquisition_RPM_data.o : $(START_DIR)/DataAcquisition_RPM_ert_rtw/DataAcquisition_RPM_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/DataAcquisition_RPM_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


encoder_wrapper.o : $(START_DIR)/encoder_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
