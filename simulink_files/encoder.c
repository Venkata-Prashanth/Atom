...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const int8_T *enc = (const int8_T *) mxGetData(PARAM_DEF0(S));
  const int8_T *pinA = (const int8_T *) mxGetData(PARAM_DEF1(S));
  const int8_T *pinB = (const int8_T *) mxGetData(PARAM_DEF2(S));
  encoder_Outputs_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const int8_T *pinA = (const int8_T *) mxGetData(PARAM_DEF1(S));
  const int8_T *pinB = (const int8_T *) mxGetData(PARAM_DEF2(S));
  encoder_Update_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
